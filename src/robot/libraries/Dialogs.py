...
def get_value_from_user(message: str, default_value: str = "", hidden: 'str | bool' = False):
...
def get_selection_from_user(message: str, *values: str, default: 'int | str | None' = None):
...
def _validate_user_input(dialog: 'InputDialog | MessageDialog | MultipleSelectionDialog | PassFailDialog | SelectionDialog') -> 'str | list[str] | bool':
    value = dialog.show()
    if value is None:
